...
public class CreateCashDesk extends Command {

    private final CashDeskID cashDeskID;
    private final CompanyHeadquarter companyHeadquarter;

    public CreateCashDesk(CashDeskID cashDeskID, CompanyHeadquarter companyHeadquarter) {
        this.cashDeskID = cashDeskID;
        this.companyHeadquarter = companyHeadquarter;
    }

    public CashDeskID getCashDeskID() {
        return cashDeskID;
    }
