...
public class UpdateProductBrandStock extends Command {
    ...
    public UpdateProductBrandStock(InventoryID inventoryID, ProductID productID, ProductBrand productBrand) {
